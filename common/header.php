            ...
            <div class="region region-main-navigation">
    			<div id="block-search-form" class="block block-search">
  					<div class="content main-navigation">
    					<form class="gss search-form form-search content-search" action="https://rbscp.lib.rochester.edu/search/gss" method="post" id="search-block-form" accept-charset="UTF-8">
                    	<div>
           					<div>
...
// update, 20190424: changing this to the generic homepage for the exhibits site, now that we have more than one exhibit on this server... eventually, it would be nice to have this be dynamic and link to the homepage for each individual exhibit
                
				 //echo "<a href='/exhibits/show/womens-rights-movement'>" . bs_header_logo();  
                echo "<a href='/exhibits'>" . bs_header_logo(); 
...
<!-- Added link back to RBSCP - jss, 20171121 -->        
