<?php
include 'views/helpers/LocalExhibitFunctions.php';
...
?>
    <div class="exhibit <?php if ($exhibitCount%2==1) echo ' even'; else echo ' odd'; ?>">
        <h3>
            <?php 
// using local version of exhibit functions to construct URLs for the homepage            
            echo local_link_to_exhibit(); 
...
// using local version of exhibit functions to construct URLs for the homepage        
        echo local_exhibit_builder_link_to_exhibit($exhibit, $exhibitImage, array('class' => 'image')); ?>
        <?php endif; ?>
